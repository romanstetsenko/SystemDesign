...
def create_html_with_mermaid(md_content):
    ...
    html_parts.append('<title>URL Shortener System Design</title>')
    ...
    html_parts.append('<h1>URL Shortener System Design</h1>')
    html_parts.append('<p>Generated from URL Shortener System Design.md</p>')
    ...
    html_parts.append(f'<p>Generated: {Path("URL Shortener System Design.md").stat().st_mtime if Path("URL Shortener System Design.md").exists() else "N/A"}</p>')
...
def main():
    ...
    input_file = Path("URL Shortener System Design.md")
    html_output = Path("URL Shortener System Design.html")
