...
def create_html_with_mermaid(md_content):
    ...
    html_parts.append('.mermaid {margin: 8px 0; padding: 10px; background: #f8f9fa; border: 1px solid #3498db; border-radius: 4px; text-align: center;}')
    ...
    html_parts.append('.mermaid {margin: 4px 0; padding: 6px; background: #f0f0f0; border: 1px solid #ccc; page-break-inside: avoid;}')
